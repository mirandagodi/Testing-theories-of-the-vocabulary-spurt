...
#   kbl() %>% 
#   kable_classic(full_width = F, html_font = "Times") #HK note: for me, this creates a table with a lot of NAs and a warning about an over-long path. You could also try tab_model() from the sjPlot package, which I find makes really nice model tables. 

midpoint_single_table <- 
  tab_model(midpoint_single_model,
            show.intercept = TRUE,
  show.est = TRUE,
  show.ci = 0.95,
  show.se = TRUE,
  ...
  show.r2 = TRUE,
  show.aic = TRUE,
  title = "Midpoint: single-language",
  digits = 2)
