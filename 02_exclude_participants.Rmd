...
activity_status_recruitment_log <- read_csv("data/BabysNewWords_activity_status_from_recruitment_log.csv") %>%
  slice(1:138)
```
...
# Has your child experienced chronic ear infections (5 or more)?: ear_infections_boolean: 0=no, 1=yes
...
```{r}
# Identify participants with three consecutive missing months
