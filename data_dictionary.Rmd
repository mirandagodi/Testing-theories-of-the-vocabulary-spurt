...
coefficients_04_dictionary <- create_informant(coefficients_04_df) %>% 
  info_tabular(
    Description = "Dataset includes mispoint, slope, and upper limit coefficients of the logistic curves fit to individual vocabulary data. It also includes AIC values for different types or curves.") %>%
  info_columns(
    columns = "study_id",
    info = "Unique participant identifier.") %>%
  info_columns(
