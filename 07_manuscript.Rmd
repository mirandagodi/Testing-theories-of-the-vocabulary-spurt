...
table_descriptives_df <- step2_df %>%
  ...
  select(measure,"English (n = 22, 54%).M (SD)":"word (n = 33, 70%).Range") #HK note: Just a note that after rerunning all scripts/resaving all the data after this code review, the column names in these lines might have to be updated, since they are created manually based off of another table.
