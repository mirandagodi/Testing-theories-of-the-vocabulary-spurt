...
singlelang_individual_logistic_plot <- curve_spurters %>% 
  ...
  scale_color_gradient(low = "olivedrab2", high = "deeppink3") +
  theme_bw() +
...
combinedlang_individual_logistic_plot <- curve_spurters %>% 
  ...
  scale_color_gradient(low = "dodgerblue", high = "orangered3") +
  theme_bw() +
  theme(legend.position="bottom") +
  facet_wrap(vars(vocabulary_type_step1), nrow = 2, scales = "free") 
...
all_logistic_plots
ggsave(file="logistic_curve_plots.jpg", all_logistic_plots, width = 20, height = 16, units = "cm")
...
step2_plots
ggsave(file="step2_plots.jpg", step2_plots, width = 17, height = 12, units = "cm")
...
wordslearned_plots
ggsave(file="wordslearned_plots.jpg", wordslearned_plots, width = 17, height = 8, units = "cm")
```
